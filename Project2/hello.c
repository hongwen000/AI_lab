 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_5hello_sum)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    ...
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        {
                            __pyx_v_5hello_i = (int)(0 + 1 * __pyx_t_2);
 ...
 * print(sum)             # <<<<<<<<<<<<<<
 */
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_5hello_sum); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 10, __pyx_L1_error)
